 ...
 * To make plugin specific changes, you should edit CaeUnsAMF.cxx
...
{
    CaeUnsAMF plugin(pRti, model, pWriteInfo);
    return plugin.run();
}
...
{
    return CaeUnsAMF::create(*pRti);
}

PWP_VOID
runtimeDestroy(CAEP_RTITEM *pRti)
{
    return CaeUnsAMF::destroy(*pRti);
}
