...
#define ID_CaeUnsAMF  1169
{
    ...
    CaeUnsAMFBCInfo,            /* CAEP_BCINFO* */
    ARRAYSIZE(CaeUnsAMFBCInfo), /* PWP_UINT32 BCCnt */

    /*== CAEP_VCINFO*    pVCInfo;    -- array of format VCs or NULL */
    /*== PWP_UINT32      VCCnt;      -- # format VCs */
    CaeUnsAMFVCInfo,            /* CAEP_VCINFO* pVCInfo */
    ARRAYSIZE(CaeUnsAMFVCInfo), /* PWP_UINT32 VCCnt */

    /*== const char**    pFileExt;   -- array of valid file extensions */
    /*== PWP_UINT32      ExtCnt;     -- # valid file extensions */
    CaeUnsAMFFileExt,            /* const char **pFileExt */
    ARRAYSIZE(CaeUnsAMFFileExt), /* PWP_UINT32 ExtCnt */
