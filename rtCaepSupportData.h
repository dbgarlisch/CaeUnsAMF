...
/*------------------------------------*/
/* CaeUnsAMF format item setup data */
/*------------------------------------*/
CAEP_BCINFO CaeUnsAMFBCInfo[] = {
    { "patch", 100 },
};
/*------------------------------------*/
CAEP_VCINFO CaeUnsAMFVCInfo[] = {
    { "body", 200 },
};
/*------------------------------------*/
const char *CaeUnsAMFFileExt[] = {
    "amf"
};
/*! \endcond */
...
\skip == CAEP_BCINFO*
\until ARRAYSIZE(CaeUnsAMFFileExt)
*/
